...
export declare namespace TheSourceArticle {
  export type ArticleStruct = {
    title: PromiseOrValue<string>;
    description: PromiseOrValue<string>;
    authorName: PromiseOrValue<string>;
...
export interface TheSourceArticleInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "getNumberOfArticles",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TheSourceArticle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TheSourceArticleInterface;
